...
links = []
links.append('https://www.balenciaga.com/en-pl/new-arrivals/discover/new-arrivals_skiwearcollection')
    ...
    for category_link in products_categories:
        ...
        if ('https://www.balenciaga.com/en-pl/searchcontent?fdid=evenings-dresses' == category_link.find('a').get('href') or
                ...
                'https://www.balenciaga.com/en-pl/men/small-leather-goods/view-all' == category_link.find('a').get(
                    'href') or
                'https://www.balenciaga.com/en-pl/men/accessories/view-all' == category_link.find('a').get('href') or
        'https://www.balenciaga.com/en-pl/men/ready-to-wear/men_rtw_skiwearcollection' == category_link.find('a').get('href') or
        'https://www.balenciaga.com/en-pl/women/ready-to-wear/women_rtw_skiwearcollection' == category_link.find('a').get('href') or
            'https://www.balenciaga.com/en-pl/women/shoes/women_shoes_skiwearcollection' == category_link.find('a').get('href') or
            'https://www.balenciaga.com/en-pl/women/accessories/women_accessories_skiwearcollection' == category_link.find('a').get('href') or
            'https://www.balenciaga.com/en-pl/men/shoes/men_shoes_skiwearcollection' == category_link.find('a').get('href') or
            'https://www.balenciaga.com/en-pl/men/bags/men_bags_skiwearcollection' == category_link.find('a').get('href') or
            'https://www.balenciaga.com/en-pl/men/accessories/men_accessories_skiwearcollection' == category_link.find('a').get('href') or
            'https://www.balenciaga.com/en-pl/new-arrivals/discover/winter-23-women' == category_link.find('a').get('href') or
            'https://www.balenciaga.com/en-pl/new-arrivals/discover/winter-23-men' == category_link.find('a').get('href') ):
            continue
        if discovered_links.__contains__(link):
            continue
        if link.__contains__('/view-all'):
            continue
        else:
        ...
        for product_url in elements_links:
            ...
            try:
                ...
                categories_list = []
                if link.__contains__('skiwearcollection'):
                    categories_list.append('Skiwear Collection')
                else:
                ...
                if product_names.__contains__(name):
                    continue
                product_data = {
                    "Enabled": 1,
                    "Name": name,
